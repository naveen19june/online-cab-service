...
<% String fn=request.getParameter("tr");%>
<% String fn1=request.getParameter("tr1");%>
<% String fn2=request.getParameter("tr2");%>
<% String fn3=request.getParameter("tr3");%>
...
<input type="text" name="key" value="<%= merchant_key %>" />
      ...
      <input name="furl" value="http://localhost:8080/icab_booking/failed.jsp?yn=<%=fn%>&yn1=<%=fn1%>&yn2=<%=fn2%>&yn3=<%=fn3%>&yn4=<%=fn4%>&yn5=<%=txnid%>&yn6=<%=fn5%>"/> 
    </div>
    <div style="padding: 20px; border: 1px solid #ddd; width: 40%;margin-left: 400px; text-align: left;">
        <img src="images/logo.png" style="padding: 0px 10px 10px 10px;" >
    <table align='center' bgcolor='#3eed2a' width='100%' height='50'>
      ...
      <table class='tab'align="center" width="100%">
        ...
        <tr>
          <td>Adults: </td>
          <td><input type='text' name="phone" value="<%=fn2%>" readonly/></td>
         </tr>
        <tr>
          <td>Children: </td>
          <td><input type='text' name="productinfo" value="<%=fn4%>" readonly /></td>
        </tr>  
         <tr>
          <td>Fare: </td>
          ...
          <tr>
          <td>Date: </td>
          <td><input type='text' name="date" value="<%=fn5%>" readonly /></td>
        </tr> 
        </table><br/>
        <table align='center'>
        <tr>
